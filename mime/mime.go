...
var (
	ErrEmptyMime    = errors.New("mime is required")                               // ErrEmptyMime is returned when the input string is empty.
	ErrInvalidMime  = errors.New("mime type must be in the format 'type/subtype'") // ErrInvalidMime is returned when the string exists but doesn't follow the 'type/subtype' structure (e.g., missing the forward slash).
	ErrEmptyType    = errors.New("mime type is empty")                             // ErrEmptyType is returned when the output MIME type is empty.
	ErrEmptySybtype = errors.New("mime subtype is empty")                          // ErrEmptySybtype is returned when the output MIME subtype is empty.
)
